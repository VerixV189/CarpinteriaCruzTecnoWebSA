...
const breadcrumbs: BreadcrumbItem[] = [
    ...
    { title: 'Nuevo', href: route('productos.create') },
];
    ...
    <AppLayout :breadcrumbs="breadcrumbs">
        <div class="p-6 w-full max-w-4xl mx-auto space-y-6">
            <div class="flex items-center gap-4">
                ...
                <div>
                    <h1 class="text-2xl font-bold text-foreground">Crear Nuevo Producto</h1>
                    <p class="text-sm text-muted-foreground">Ingresa los detalles del nuevo producto para el catálogo.</p>
                </div>
            </div>
