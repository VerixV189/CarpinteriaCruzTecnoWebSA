...
const breadcrumbs: BreadcrumbItem[] = [
    ...
    { title: 'Editar', href: `/tipos/${props.tipo.id}/edit` },
];
...
<template>
    <Head title="Editar Tipo de Mueble" />
    ...
    <AppLayout :breadcrumbs="breadcrumbs">
        <div class="p-6 w-full max-w-2xl mx-auto space-y-6">
            <div class="flex items-center gap-4">
                ...
                <div>
                    <h1 class="text-2xl font-bold text-foreground">Editar Tipo de Mueble: {{ tipo.nombre }}</h1>
                    <p class="text-sm text-muted-foreground">Modifica la categoría de muebles.</p>
                </div>
            </div>
