...
const form = useForm({
    ...
    permisos: props.role.permisos.map((p: any) => p.id),
});
    ...
    <AppLayout :breadcrumbs="breadcrumbs">
        <div class="p-6 w-full max-w-4xl mx-auto space-y-6">
            <div class="flex items-center gap-4">
                ...
                <div>
                    <h1 class="text-2xl font-bold text-foreground">Editar Rol: {{ role.nombre }}</h1>
                    <p class="text-sm text-muted-foreground">Modifica el nombre del rol y actualiza sus permisos.</p>
                </div>
            </div>
            ...
            <form @submit.prevent="submit" class="grid grid-cols-1 md:grid-cols-3 gap-6">
                ...
                <div class="md:col-span-2">
                    <div class="rounded-md border border-sidebar-border bg-card shadow-sm p-6 h-full">
                        ...
                        <p class="text-sm text-muted-foreground mb-4">Selecciona o desmarca las acciones que este rol podrá realizar.</p>
