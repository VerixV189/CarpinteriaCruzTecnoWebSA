    ...
    <AppLayout :breadcrumbs="breadcrumbs">
        <div class="p-6 w-full max-w-2xl mx-auto space-y-6">
            <div class="flex items-center gap-4">
                ...
                <div>
                    <h1 class="text-2xl font-bold text-foreground">Registrar Nuevo Insumo</h1>
                    <p class="text-sm text-muted-foreground">Ingresa los datos para registrar un nuevo insumo/material.</p>
                </div>
            </div>
                ...
                <form @submit.prevent="submit" class="space-y-6">
                    <div class="space-y-4">
                        <div class="space-y-2">
                            ...
                            <input v-model="form.nombre" type="text" placeholder="Ej: Madera Roble 1x8 (Pies)" required class="flex h-9 w-full rounded-md border border-input bg-background px-3 py-1 text-sm shadow-sm" />
