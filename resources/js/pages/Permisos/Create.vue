...
const breadcrumbs: BreadcrumbItem[] = [
    ...
    { title: 'Nuevo', href: route('permisos.create') },
];
    ...
    <AppLayout :breadcrumbs="breadcrumbs">
        <div class="p-6 w-full max-w-2xl mx-auto space-y-6">
            <div class="flex items-center gap-4">
                <Link :href="route('permisos.index')" class="p-2 rounded-md hover:bg-muted transition-colors">
            ...
            <div class="rounded-md border border-sidebar-border bg-card shadow-sm p-6">
                <form @submit.prevent="submit" class="space-y-6">
                    ...
                    <div class="flex justify-end gap-3 pt-4 border-t">
                        <Link :href="route('permisos.index')" class="inline-flex items-center justify-center rounded-md border border-input bg-background px-4 py-2 text-sm font-medium shadow-sm hover:bg-accent hover:text-accent-foreground transition-colors">
                            Cancelar
                        </Link>
