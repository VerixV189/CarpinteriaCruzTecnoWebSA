...
<template>
    ...
    <AppLayout :breadcrumbs="breadcrumbs">
        <div class="p-6 max-w-2xl mx-auto space-y-6">
            <div>
                <h1 class="text-2xl font-bold text-foreground">Registrar Nuevo Cliente</h1>
                <p class="text-sm text-muted-foreground">Completa la información del usuario y los datos del cliente.</p>
            </div>
